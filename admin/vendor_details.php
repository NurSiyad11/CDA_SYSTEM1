		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
                    <?php
                      $ven_name = $conn->query("SELECT name as cid from `user` where id='$get_id'  ")->fetch_assoc()['cid'];  
                    ?>
                    ...
                    <div class="card-box mb-30">
                        ...
                        <div class="pd-20" >
                                ...
                                <h2 class="text-blue h4"><?php echo "Customer Name:  $ven_name"?></h2>
                            ...
                            <table class="data-table table stripe hover nowrap">
                                ...
                                <tbody>
									...
									?>
                                        ...
                                        $sql = "SELECT id,D_INV, V_invoice,Date,Memo,Amount,empty FROM ven_invoice where Vid='$Vname' UNION All SELECT id,D_PV, V_payment,Date,Memo,empty,Amount FROM ven_payment where Vid='$Vname'  order by Date desc ";
