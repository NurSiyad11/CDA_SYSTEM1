...
<?php
	...
	{	
       ...
       //Set sender email
           $mail->setFrom('siyaadgeneralservice@gmail.com', "CDA Reset Password");
       //Enable HTML
           $mail->isHTML(true);
       //Attachment
           ...
           <html>
              <body style=\"border: 2px solid #1D058D; margin: 25px 10px 20px 10px; padding: 5px 5px 5px 5px; \" >
                 ...
                 <h2  style=\"text-align:center; color: White; font-size: 200%; margin: 0px 0px 0px 0px; background-color : #1D058D; padding: 15px 5px 15px 5px;\">C.D.A SYSTEM .....</h2>               
					...
					<strong>Si Aad u sameysato password kuu gaar ah fadlan riix linkigaan  :  </strong> <a  href=\"http://localhost/TestingPhp/deskapp_cda/Password_gen/index.php?edit=".$ID_gmail ."\"> Reset Password </a> <br/>
					<br/><br>
       ...
       //Finally send email
           if ( $mail->send() ) {
            ...
            <?php
            mysqli_query($conn,"update user set Pass_status='0' where ID='$ID_gmail' ") or die(mysqli_error());
            ?>
                <script>       
               window.location = "user_send_reset_password.php"; 
               </script>
                <?php	
           }else{
            ?>
												...
												<div class="col-12">
													<div class="form-group">
														...
														<div class="modal-footer justify-content-center">
															<a  href="#" class="btn btn-primary" data-toggle="modal" data-target="#Medium-modal"><i class="dw dw-email-1"></i> Send Reset Password</a>
														</div>
													</div>
												</div>
											</div>                               
