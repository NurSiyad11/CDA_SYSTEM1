				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Customer Receipts Transection</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Cust_Report.php">Back </a></li>
									<li class="breadcrumb-item active" aria-current="page">Receipt Transectio </li>
								</ol>
							</nav>
						</div>
					</div>
                            ...
                            <table class="data-table table stripe hover nowrap">
                                ...
                                <tbody>
									...
									?>
                                        ...
                                        $sql = "SELECT * FROM receipt where Cid='$Cname' order by Date desc ";
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLongTitle">Receipt Pdf</h5>
											...
											<li>
                                                ...
                                                <section>
                                                    <div class="row">
                                                        ...
                                                        $teacher_query = mysqli_query($conn,"select * from receipt where Cid='$get_id' ") or die(mysqli_error());
                                                        while ($row = mysqli_fetch_array($teacher_query)) {
                                                        $id = $row['id'];
                                                        $today= $conn->query("SELECT id as eid from `receipt` where id='$id' ")->fetch_assoc()['eid'];
                                                        
                                                        $sql="SELECT File from receipt where id='$today' ";
