	...
	<div class="main-container">
		<div class="pd-ltr-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-20 text-secondary weight-500">Invoices</div>
							</div>
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-20 text-secondary weight-500">Receipts</div>
							</div>
							<!-- <div class="widget-icon">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">Customer Balance Summary</h2>
					</div>
				<div class="pb-20">
