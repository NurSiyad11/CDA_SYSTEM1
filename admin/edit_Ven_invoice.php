					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="venndor_invoice.php">Back</a></li>
                ...
                <div class="pd-20 card-box mb-30">
					...
					<div class="wizard-content">
						<form method="post" action="" enctype="multipart/form-data">
							<section>
                            <?php
									$query = mysqli_query($conn,"SELECT user.Name, ven_invoice.id, ven_invoice.Vid,ven_invoice.V_invoice ,ven_invoice.Amount,ven_invoice.Date,ven_invoice.Memo FROM ven_invoice INNER JOIN user ON   ven_invoice.Vid=user.ID  where ven_invoice.id = '$get_id' ")or die(mysqli_error());
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="invoice" type="text" placeholder="Vendor Invoice No#" class="form-control" required="true" autocomplete="off" value="<?php echo $row['V_invoice']; ?>" >
										</div>
									</div>
								</div>
...
<!-- 
							...
							<!-- <section>
                                <div class="row">
                                    ...
                                    //$sql="SELECT File from ven_invoice where id='$get_id' ";
