					...
					<div class="card-box height-100-p widget-style1 bg-white">
						<div class="d-flex flex-wrap align-items-center">
							<div class="progress-data">
								<a href="user_info_individual.php"><div id="">
							...
							<div class="widget-data">
								...
								<div class="weight-300 font-16">Total User Uses System</div>
							</div>
						</div>
					</div>
				</div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>                            
							<tr>
								 <?php
                                 $i=1;
		                         $teacher_query = mysqli_query($conn,"Select user.Name, user.Com_name, user.Picture, user.Role, user_info.id, user_info.Device, user_info.OS, user_info.Browser, user_info.Login_status, user_info.Login_time FROM user_info INNER JOIN user ON   user_info.UID=user.ID order by user_info.id Desc ") or die(mysqli_error());
