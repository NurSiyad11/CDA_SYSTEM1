				...
				<ul id="accordion-menu">
                    ...
                    <li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-user"></span><span class="mtext">Checking</span>
						</a>
						<ul class="submenu">
							<li><a href="New_Receipt.php">New Receipts</a></li>
							<li><a href="All_Receipt.php">All Customer Receipts</a></li>
						</ul>
					</li>
